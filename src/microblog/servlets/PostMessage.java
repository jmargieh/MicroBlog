...
public class PostMessage extends HttpServlet implements SingleThreadModel {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Message.PostNewMsg(Integer.parseInt(user.getUserID()), user.getNickname(), m.getContent());
		
        ArrayList<Message> MsgsArray = new ArrayList<Message>();
        MsgsArray = Message.getTop10MsgsOfUserID(Integer.parseInt(user.getUserID())); // return top 10 of user posting the msg
